...
export const transformMusician = (dataForm: any) => {
  return new Musician(dataForm.id, dataForm.name, dataForm.address, dataForm.district, dataForm.city.value, dataForm.zipCode, dataForm.phoneNumber, dataForm.celNumber,
    ...
    dataForm.promise, dataForm.prayingHouse.value, dataForm.ministryOrPosition ? dataForm.ministryOrPosition.map((ministryOrPosition: any) => ministryOrPosition.id) : undefined, dataForm.instrument.value, dataForm.oficializationDate);
}